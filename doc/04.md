...
**quadro 22** - La domanda telematica è soggetta al pagamento della marca da
...
l'Immigrazione (SUI) della Prefettura di di Milano che provvederanno, in base all'ordine cronologico di presentazione, ad inviare alla mail indicata nell'istanza la data dell'appuntamento per la consegna di tutta la documentazione.
